...
- Milestone ID: M3
- Timestamp: 2026-09-15T03:26:01+00:00
- Hostname: llmserver
- User: root
- Branch: unknown
...
| `/data` | `/dev/sdb1` | `ext4` | `AI_DATA` | `8daf56f1-5649-4163-9d87-919c2d271875` | 1249 |
...
- `scripts/common/root-disk-guard.sh --report /data/build/d3p-d3b2-20260915/evidence/canonical-preflight.md`
