...
- Milestone ID: M3
- Timestamp: 2026-09-15T03:43:09+00:00
- Hostname: llmserver
- User: root
- Branch: unknown
...
/dev/sdb1                         ext4  2.0T  665G  1.3T  35% /data
...
| --- | --- | --- | --- | --- | --- |
| `/` | `/dev/mapper/ubuntu--vg-ubuntu--lv` | `ext4` | n/a | device id `785412` | 5 |
| `/data` | `/dev/sdb1` | `ext4` | `AI_DATA` | `8daf56f1-5649-4163-9d87-919c2d271875` | 1248 |
...
| `/var/log` | yes | 379 | PASS | below warning threshold |
...
- `scripts/common/root-disk-guard.sh --report /data/build/d3p-d3b2-20260915/evidence/canonical-close.md`
