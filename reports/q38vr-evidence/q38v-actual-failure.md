...
- Host fixture SHA256 `9cdea022e21f1859e097be51094b9d2822dfc1387f8756448dd7b14d8a251d2c`; inner fixture SHA256 `16a1e0b726295e0f0a9f046b5d496dae70f83677f5145ffdb52bfee01671b454`. All other fixture/support hashes are in `source-identities.json`.
...
- Final launch plan was published before execution in `fixture-plan.md`, including exact interpreter/script argv and task paths. Host `-B` suppresses bytecode writes; helper and shipped container command are unchanged.
- Sanitized report/evidence will be included in the report-only Q38V commit/bundle after secret scan. No push.
