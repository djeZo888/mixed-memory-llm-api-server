...
- Milestone ID: M3
- Timestamp: 2026-09-15T00:21:19+00:00
- Hostname: llmserver
- User: root
- Branch: unknown
...
/dev/sdb1                         ext4  2.0T  615G  1.3T  33% /data
...
| --- | --- | --- | --- | --- | --- |
| `/` | `/dev/mapper/ubuntu--vg-ubuntu--lv` | `ext4` | n/a | device id `785498` | 5 |
| `/data` | `/dev/sdb1` | `ext4` | `AI_DATA` | `8daf56f1-5649-4163-9d87-919c2d271875` | 1298 |
...
| `/var/log` | yes | 361 | PASS | below warning threshold |
...
- `scripts/common/root-disk-guard.sh --report /data/build/f1d-qwen-20260915/evidence/handoff-root-guard.md`
