...
- Milestone ID: M3
- Timestamp: 2026-09-15T02:48:48+00:00
- Hostname: llmserver
- User: root
- Branch: unknown
...
| --- | --- | --- | --- | --- | --- |
| `/` | `/dev/mapper/ubuntu--vg-ubuntu--lv` | `ext4` | n/a | device id `785485` | 5 |
...
- `scripts/common/root-disk-guard.sh --report /data/services/n1vm-20260915/root-guard-final.md`
