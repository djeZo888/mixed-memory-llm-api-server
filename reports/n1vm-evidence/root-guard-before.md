...
- Milestone ID: M3
- Timestamp: 2026-09-15T02:41:33+00:00
- Hostname: llmserver
- User: root
- Branch: unknown
...
/dev/sdb1                         ext4  2.0T  663G  1.3T  35% /data
...
| --- | --- | --- | --- | --- | --- |
| `/` | `/dev/mapper/ubuntu--vg-ubuntu--lv` | `ext4` | n/a | device id `785494` | 5 |
| `/data` | `/dev/sdb1` | `ext4` | `AI_DATA` | `8daf56f1-5649-4163-9d87-919c2d271875` | 1250 |
...
| `/var/log` | yes | 378 | PASS | below warning threshold |
...
- `scripts/common/root-disk-guard.sh --report /data/services/n1vm-20260915/root-guard-before.md`
