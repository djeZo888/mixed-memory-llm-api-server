...
`LICENSE-AGPL-3.0.txt` plus `NOTICE.md`. No host configuration/workspace mount is
needed. The upstream image declares two volumes; use Podman's
...
The engine receives `AI_HARNESS_SEARXNG_URL=http://10.0.2.2:8082`; this candidate
