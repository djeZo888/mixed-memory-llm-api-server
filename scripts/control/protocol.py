...
class Session(Protocol):
    ...
    def preflight(self, target: str, lease, deadline: Deadline, *, slot: str | None = None) -> None: ...
    def stop(self, lease, deadline: Deadline, *, slot: str | None = None) -> None: ...
    def select(self, target: str, lease, deadline: Deadline, *, slot: str | None = None) -> None: ...
    def start(self, lease, deadline: Deadline, *, slot: str | None = None) -> None: ...
