...
- **DONE on ai-vm and ai-harness:** disable automatic APT updates and the
  ...
  available. See the [verified H007 policy and coverage limits](docs/h007-update-policy-20260926.md).
...
- Keep needrestart protection distinct: deferring automatic restarts does not
  itself disable package installation. [H006 maintenance protection](docs/h006-maintenance-robustness.md)
