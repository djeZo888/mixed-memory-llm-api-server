...
Install and configure the approved NVIDIA Container Toolkit path after M5A and M5 pass. Verify `docker run --gpus all ... nvidia-smi` works while Docker storage remains on `/data`.
